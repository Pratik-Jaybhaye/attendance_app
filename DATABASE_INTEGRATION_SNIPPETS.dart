...
Future<void> saveAttendanceAfterCapture({
  ...
  try {
    ...
    final isSaved = await AttendanceService.saveAttendanceLocally(attendanceRecord);
...
Future<void> displayClassAttendance(String classId) async {
  ...
  for (final record in records) {
    print('${record.dateTime}: ${record.presentCount} present, ${record.absentCount} absent');
  }
}
